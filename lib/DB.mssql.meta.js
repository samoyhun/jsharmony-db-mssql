...
DBmeta.prototype.getTables = function(table, options, callback){
  ...
  var sql = "select \
      ...
      (select count(*) from sys.triggers t inner join sys.trigger_events te on te.object_id=t.object_id where t.is_instead_of_trigger=1 and te.type_desc='INSERT') instead_of_insert \
      from sys.objects \
