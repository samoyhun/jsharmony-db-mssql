...
exports.getTitle = function (ent, model, sql, datalockqueries) {
  sql = parseSQL(ent, sql);
...
exports.getLOV = function (ent, fname, lov, datalockqueries, param_datalocks, options) {
