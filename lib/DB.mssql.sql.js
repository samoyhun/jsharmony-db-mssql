...
exports.getSearchTerm = function (ent, field, pname, search_value, comparison) {
  ...
  var fsql = field.name;
  if (field.sql_search){
    fsql = ent.parseFieldExpression(field, parseSQL(ent, field.sql_search), { SQL: field.name });
  }
  else if (field.sql_from_db){
    fsql = ent.parseFieldExpression(field, parseSQL(ent, field.sql_from_db), { SQL: field.name });
  }
